            ...
            <View style={{ justifyContent: 'center' }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <TouchableOpacity onPress={() => {
                        ...
                        <Image style={{ width: 150, height: 18, marginTop: 65, marginLeft: 30 }} source={require('../images/huongdan.png')} />
                    </TouchableOpacity>

                    <Image style={{ width: 80, height: 65, marginLeft: 120, marginTop: 50 }} source={require('../images/tramtaisinhvuong.png')} />
                </View>

                <Image style={{ width: 280, height: 280, alignSelf: 'center' }} source={require('../images/boxthanhhang.png')} />
                <Image style={{ width: 250, height: 33, alignSelf: 'center' }} source={require('../images/chainhuarong.png')} />
