    ...
    <View>
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <ImageBackground
              ...
              <Image
                style={styles.tichdiem}
                source={require('../images/tichdiem.png')}
              />
              <Image
              ...
              <TouchableOpacity
                ...
                <Image
                  style={styles.btnTichdiem}
                  source={require('../images/btnTichdiem.png')}
                />
              </TouchableOpacity>
              <TouchableOpacity
      ...
      <View style={{ height: 900, backgroundColor: '#EAF0F8' }}>
        <View style={{ justifyContent: 'center' }}>
          ...
          <Image
            style={styles.xuly}
            source={require('../images/xuly.png')}
          />
          <ImageBackground
            style={styles.bgxoay}
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <Image
                style={{ width: 80, height: 65, marginLeft: 230 }}
            ...
            <View style={{ flexDirection: 'row', marginTop: 15, alignSelf:'center' }}>
              <Text style={{ color: '#707172', fontWeight: 'bold', paddingRight: 5 }}>
          ...
          <TouchableOpacity
            ...
            <Image
              ...
              source={require('../images/hoantat.png')}
            />
          </TouchableOpacity>
        </View>
      </View>
